...
public class MongoCollectionReactiveRepo {
    ...
    public interface OnUpdate {
        ...
        Mono<List<Document>> insertElements(List<Document> documentList, boolean ordered);
    ...
    public interface OnSearchBy {
        ...
        Flux<Optional<MongoCursor<Document>>> findsElementsBySingleQuery(Bson searchQuery);
